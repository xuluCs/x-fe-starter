                ...
                data: theme.appTheme.copyWith(
                  textTheme: TextTheme(
                    ...
                    displayMedium: textStyle.copyWith(
                        fontSize: (textTheme?.displayMedium ?? 45).toDouble()),
                    displaySmall: textStyle.copyWith(
                        fontSize: (textTheme?.displaySmall ?? 36).toDouble()),
                    headlineLarge: textStyle.copyWith(
                        fontSize: (textTheme?.headlineLarge ?? 32).toDouble()),
                    headlineMedium: textStyle.copyWith(
                        fontSize: (textTheme?.headlineMedium ?? 28).toDouble()),
                    headlineSmall: textStyle.copyWith(
                        fontSize: (textTheme?.headlineSmall ?? 24).toDouble()),
